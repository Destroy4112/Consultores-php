...
<html lang="en">
   ...
   <body id="default_theme" class="services">
      ...
      <!-- end header -->
      <h2 style="text-align: center; font-size: 40px; margin-top: -150px;">Consultorías Administrativas</h2>
      <p style="font-size: 20px; text-align: center; padding: 30px;"> Obtén con nosotros un gran desempeño en tus servicios y bienes, para una gran oportunidad de mejora.</p>
      <!-- section -->
            ...
            <div class="row app-features">
               ...
               <div class="col-sm-12 col-md-6">
                           <div class="active_price table_price text_align_center">                           
                                 <h3>Emprendimiento Empresarial</h3>                            
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/emprendimiento.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                           <div class="active_price table_price text_align_center">                           
                              ...
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/seminario.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                           <div class="active_price table_price text_align_center">                           
                                 <h3>Asesoria de Planes de Negocio</h3>                            
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/planesnegocio.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                           <div class="active_price table_price text_align_center">                           
                              ...
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/empresas.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
                        ...
                        <div class="col-sm-12 col-md-12">
                           <div class="active_price table_price text_align_center">                           
                                 <h3>Trámites de legalización frente a cámara de comercio</h3>                            
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/camara.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
