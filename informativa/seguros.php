...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Asesoria de seguros</title>
   ...
   <body id="default_theme" class="services">
      ...
      <!-- end header -->
      <h2 style="text-align: center; font-size: 40px; margin-top: -150px;">Asesoria de seguros <h5 style="text-align: center;">Seguros - SOAT</h5> </h2>
      <p style="font-size: 20px; text-align: center; padding: 30px;"> Logra con nosotros un completo manejo, asegura tu vehículo de la mejor forma posible.</p>
      <!-- section -->
               ...
               <div class="col-sm-12 col-md-6">
                           <div class="active_price table_price text_align_center">                           
                              ...
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/carro.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                           <div class="active_price table_price text_align_center">                           
                              ...
                              <div class="table_price_cont">
                                 <div class="table_price_per">
                                   <img src="../images/moto.svg" width="300px" alt="">
                                    </p>
                                 </div>                                
                              </div>
                           </div>
