                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-user"></i> Editar Noticia
                            </div>
                            <div class="card-body">

                                <form action="../metodos/actualizarNoticia.php" method="post">
                                    <div class="modal-body">
                                        <label>Titulo</label>
                                        <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                        <input type="text" value="<?php echo $row['Titulo'] ?>" name="titulo" class="form-control" placeholder="Ingrese el titulo...."><br>
                                        <label>Imagen</label><br>
                                        <img src="../images/noticias/<?php echo $row['Imagen']; ?>" style="height: 250px;width: 250px" alt=""><br><br>
                                        <label>Descripcion</label>
                                        <textarea name="descripcion" class="form-control"><?php echo $row['Descripcion'] ?></textarea><br>
                                    </div>
